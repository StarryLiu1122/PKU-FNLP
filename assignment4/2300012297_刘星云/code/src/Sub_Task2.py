...
if __name__ == "__main__":
    ...
    parser.add_argument('--dict_path', type=str, default='../Data_project_2/dictionary_za2zh.jsonl')
    parser.add_argument('--corpus_path', type=str, default='../Data_project_2/parallel_corpus.json')
    parser.add_argument('--grammar_path', type=str, default='../Data_project_2/grammar_book.json')
    parser.add_argument('--test_data_path', type=str, default='../Data_project_2/test_data.json')
    ...
    # output path
    parser.add_argument('--output_path', type=str, default="../output/submission2.jsonl")
    ...
    # construct prompt 
    prompt_func = construct_prompt_za2zh
    # prompt_func = zero_shot_task2
    # prompt_func = construct_prompt_za2zh_with_all_grammar
    ...
    for item in tqdm(test_data):
        ...
        # construct prompt
        prompt = prompt_func(src_sentence, dictionary, parallel_corpus, grammar, args)
        # print(prompt)
